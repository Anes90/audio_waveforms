...
object Constants {
    ...
    const val playerRate = "playerRate"
    const val halfSpeed = "halfSpeed"
    const val normalSpeed = "normalSpeed"
    const val oneAndHalfSpeed = "oneAndHalfSpeed"
    const val twoTimesSpeed = "twoTimesSpeed"
}
